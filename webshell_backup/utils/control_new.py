...
class ControlUtil:
    ...
    def _create_container(container):
        """
        Create a Docker container for WebShell - aligned with CTFd-whale approach
        ...
        # Create service (swarm mode container) configured for Kasm but using CTFd-whale approach
        try:
